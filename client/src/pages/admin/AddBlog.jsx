...
const AddBlog = () => {
    ...
    const generateContent = async () => {
       if(!title) return toast.error("Please enter a title")
        ...
        try {
            ...
            if(data.success){
                // to use parse install npm i marked
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
        ...
        <select value={category} onChange={(e) => setCategory(e.target.value)} name="category" id="" className='mt-2 px-3 py-2 border text-gray-500 border-gray-300 outline-none rounded'>
